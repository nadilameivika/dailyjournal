...
if (isset($_POST['simpan'])) {
    ...
    if ($gambar_baru != '') {
        // Tentukan lokasi gambar yang akan disimpan
        $target_dir = "img/";
        ...
        if (move_uploaded_file($_FILES['gambar']['tmp_name'], $target_file)) {
            ...
            $sql_update = "UPDATE gallery SET gambar = '$gambar_baru' WHERE id = '$id'";
...
if (isset($_POST['hapus'])) {
    ...
    $sql_hapus = "DELETE FROM gallery WHERE id = '$id'";
    if ($conn->query($sql_hapus) === TRUE) {
        echo "Gallery berhasil dihapus.";
    } else {
...
<nav class="mb-2">
    <ul class="pagination justify-content-end">
        ...
        <ul class="pagination">
            ...
            for($i = $start_number; $i <= $end_number; $i++){
                if($i == $hlm){
                    ...
                    echo '<li class="page-item halaman" id="'.$i.'"><a class="page-link" href="#">'.$i.'</a></li>';
                }
            }
            ?>
        </ul>
        ...
        if($hlm == $jumlah_page){
            ...
            echo '<li class="page-item halaman" id="'.$link_next.'"><a class="page-link" href="#">Next</a></li>';
